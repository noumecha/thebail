...
class FicheCollecteFormHandler {
  ...
  async collectFormData() {
    ...
    const data = {
      ...
      contrat: {
        ...
        Existence_visa_budgétaire: getCheckboxValueYesNo('Existence_visa_budgétaire'),
        Duree_Contrat: getValue('Duree_Contrat'),
        Tacite_reconduction_contrat: getCheckboxValueYesNo('Tacite_reconduction_contrat'),
        ...
        Existence_avenant: getCheckboxValueYesNo('Existence_avenant'),
        bailleur: {
  ...
  collectAvenants() {
    ...
    const avenant1 = {
      ...
      statut_visa_budgetaire_avenant: getCheckboxValueYesNo('statut_visa_budgetaire_avenant_1'),
    ...
    const avenant2 = {
      ...
      statut_visa_budgetaire_avenant: getCheckboxValueYesNo('statut_visa_budgetaire_avenant_2'),
